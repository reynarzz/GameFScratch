...
namespace Engine
{
    public class Camera : Component
    {
        ...
        public mat4 View => InvertCameraTransform(Transform.WorldMatrix);
        ...
        private mat4 InvertCameraTransform(mat4 model)
        {
        ...
        private mat4 Ortho(float left, float right, float bottom, float top, float near, float far)
        {
        ...
        private mat4 Perspective(float fovY, float aspect, float near, float far)
        {
